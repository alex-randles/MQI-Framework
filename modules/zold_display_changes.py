...
class DisplayChanges:
    ...
    def __init__(self, user_id, testing=False):
        ...
        self.graph_details = self.manager.Queue()
        ...
        self.graph_details = self.convert_results_queue()
    ...
    def generate_display_information(self):
        ...
        # pr1 = multiprocessing.Process(target=self.iterate_mappings)
        pr2 = multiprocessing.Process(target=self.iterate_changes_graphs)
        pr2.start()
        pr2.join()
    ...
    def convert_results_queue(self):
        ...
        validation_results = []
        while not self.graph_details.empty():
            item = self.graph_details.get()
    ...
    def get_changes_count(self):
        ...
        self.current_dict["change_count"] = change_count
        return change_count
    ...
    def iterate_changes_graphs(self):
        ...
        for file in os.listdir(directory):
            ...
            # self.current_dict["filename"] = filename
            # user_graph_file
            print(filename)
            ...
            pr2 = multiprocessing.Process(target=self.get_graph_details)
            pr2.start()
    ...
    def get_graph_details(self):
        ...
        self.graph_details.put(self.current_dict)
    ...
    def get_detection_period(self):
        ...
        for row in query_results:
            ...
            self.current_dict["detection_start"] = detection_start
            self.current_dict["detection_end"] = detection_end
    ...
    def get_changes_source(self):
        ...
        if change_sources:
            ...
            self.current_dict["change_sources"] = change_sources
